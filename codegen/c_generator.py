...
class CGenerator:
    ...
    def init_inner(self):
        ...
        assert(default_type in ['double', 'float'])
...
def generate_code(output_dir, instance):
    ...
    src_main_c_path = f'codegen/main.c'
    ...
    cgen.write_kernel_wrapper(f'{output_dir}/wrapper.c')
    cgen.write_core(f'{output_dir}/core.c')
