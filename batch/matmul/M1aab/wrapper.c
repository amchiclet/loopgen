...
unsigned long long core(float A[restrict 850][850], float B[restrict 850][850], float C[restrict 1][1]);
...
int init_inner(float A[restrict 850][850], float B[restrict 850][850], float C[restrict 1][1]) {
