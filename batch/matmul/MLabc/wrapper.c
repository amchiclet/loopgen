...
unsigned long long core(float A[restrict 850][850], float B[restrict 850][850], float C[restrict 850][850]);
...
void *allocate() {
  ...
  data->B = malloc(sizeof(float) * 850 * 850);
  data->C = malloc(sizeof(float) * 850 * 850);
  return (void*)data;
}

int init_inner(float A[restrict 850][850], float B[restrict 850][850], float C[restrict 850][850]) {
