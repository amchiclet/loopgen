...
unsigned long long core(double A[restrict 1][1], double B[restrict 420][420], double C[restrict 1][1], double D[restrict 420][420], double E[restrict 1][1], double a, double b, double c);
...
int init_inner(double A[restrict 1][1], double B[restrict 420][420], double C[restrict 1][1], double D[restrict 420][420], double E[restrict 1][1], double a[restrict 1], double b[restrict 1], double c[restrict 1]) {
