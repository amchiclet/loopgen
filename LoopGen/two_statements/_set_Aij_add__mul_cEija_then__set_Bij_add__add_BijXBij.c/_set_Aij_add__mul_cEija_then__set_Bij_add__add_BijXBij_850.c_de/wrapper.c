...
unsigned long long core(double A[restrict 850][850], double B[restrict 850][850], double C[restrict 1][1], double D[restrict 1][1], double E[restrict 850][850], double a, double b, double c);
...
int init_inner(double A[restrict 850][850], double B[restrict 850][850], double C[restrict 1][1], double D[restrict 1][1], double E[restrict 850][850], double a[restrict 1], double b[restrict 1], double c[restrict 1]) {
